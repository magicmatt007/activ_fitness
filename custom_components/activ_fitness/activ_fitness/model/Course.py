...
class Course:
  def __init__(self,center_id,course_id_tac,title,instructor,start,end,max_persons,actual_persons, boooked,bookable,booking_id_tac):
    ...
    self.start_end_str = f"{self.start_obj.strftime('%a %H:%M')}-{self.end_obj.strftime('%H:%M')}"
  ...
  def from_json(json_dct):
    return Course(json_dct['centerId'],json_dct['courseIdTac'],json_dct['title'],json_dct['instructor'],json_dct['start'],json_dct['end'],json_dct['maxPersons'],json_dct['actualPersons'],json_dct['booked'],json_dct['bookable'],json_dct['bookingIdTac'])

  """ 
              "centerId": 33,
              "centerIdTac": 109,
              "courseIdTac": 13108987,
              "title": "Bodytoning 55'",
              "description": "",
              "activity": "",
              "instructor": " Paulo A.",
              "location": " _Kursraum 1",
              "start": "2022-11-24T09:00:00",
              "end": "2022-11-24T09:55:00",
              "maxPersons": 30,
              "actualPersons": 5,
              "booked": false,
              "bookable": true,
              ...
              "linkCalendar": "course/33/13108987.ics" 
  """
